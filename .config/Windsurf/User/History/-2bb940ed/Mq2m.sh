...
# Track LFS patterns only if .gitattributes is missing or incomplete
...
# No else — we leave existing tracked patterns alone
# This avoids touching the file and triggering re-uploads
done
...
if ! git diff --cached --quiet; then
  ...
  # Ensure the repo has a valid HEAD and is on a branch
