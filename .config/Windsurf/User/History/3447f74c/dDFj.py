...
sensitivity_factor = 1.0  # tuned for proper output speed
...
# Sigmoid shaped gain function (used only for extra customization, not in this exact Windows-style script)
def sigmoid(x, a=14.0):
